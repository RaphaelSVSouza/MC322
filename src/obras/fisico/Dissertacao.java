...
public class Dissertacao extends ExemplarFisico {
    private final String universidade;
    private final String doi;

    //Construtores
    public Dissertacao(int tombo, String tipo, String assunto, String registro, String titulo, 
    		...
    		String universidade, String doi) {
    	super(tombo, "Dissertação", assunto, 
    			("DIS" + "/" + universidade + "-" + assunto + tombo), titulo, 
